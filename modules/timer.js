...
export const timer = (deadline) => {
  ...
  const start = (days, hours, minutes) => {
    ...
    if (timer.days === 1 || timer.days === 21 || timer.days === 31) {
      ...
      (timer.days > 4 && timer.days < 21) ||
      (timer.days > 24 && timer.days < 31)
    ) {
    ...
    if (
      timer.hours === "01" ||
      (timer.hours % 10 === 1 && timer.hours !== "11")
    ) {
    ...
    if (
      timer.minutes === "01" ||
      (timer.minutes % 10 === 1 && timer.minutes !== "11")
    ) {
      ...
      (timer.minutes % 10 > 1 &&
        timer.minutes % 10 < 5 &&
        !(timer.minutes > "11" && timer.minutes < "15"))
    ) {
